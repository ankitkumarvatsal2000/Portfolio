  ...
  return (
   ...
   <div className='fixed top-0 left-0 right-0 '> <All_header  /></div>
      <div className=' text-center'>
        <h1 className='text-6xl font-bold mt-28'>Contact Me</h1>
        <p className='font-bold text-gray-400 mt-8'>Far far away, behind the word mountains, far from the countries Vokalia and</p>
        <p className='font-bold text-gray-400'> Consonantia</p>
      </div>
      <div className='flex gap-6 justify-center  '>
        <div className='shadow-lg rounded-md text-center  w-[300px] '>
          <div className='w-[100px] h-[100px] rounded-[100px] bg-blue-500 m-auto'> <HomeRoundedIcon className='text-white mt-8 ' /></div>
          <h1 className='font-bold text-2xl'>Address</h1>
          <p className='mt-20 text-gray-400 font-bold'>ViL-Narayanpur,Moradabad (U.P.)</p>
        </div>
        <div className='shadow-lg rounded-md text-center w-[300px]'>
          <div className='w-[100px] h-[100px] rounded-[100px] bg-blue-500 m-auto'> <CallRoundedIcon className='text-white mt-8 ' /></div>
          <h1 className='font-bold text-2xl'>Contact  no.</h1>
          <p className='mt-20  text-gray-400 font-bold'>+919761416793</p>
          <p className=' text-gray-400 font-bold'>+916398572277</p>
        </div>
        <div className='shadow-lg rounded-md text-center w-[300px]'>
          <div className='w-[100px] h-[100px] rounded-[100px] bg-blue-500 m-auto'> <MailRoundedIcon className='text-white mt-8 ' /></div>
          <h1 className='font-bold text-2xl'>Email Addess</h1>
          <p className='mt-20  text-gray-400 font-bold'>ankitkumarvatsal2000@gmail.com</p>
          <p className=' text-gray-400 font-bold'>chauhanankit7404@gmail.com</p>
        </div>
        <div className='shadow-lg rounded-lg text-center w-[300px]'>
          <div className='w-[100px] h-[100px] rounded-[100px] bg-blue-500 m-auto'><LinkedInIcon className='text-white mt-8 ' /></div>
          <h1 className='font-bold text-2xl'>LinkedIn Profile</h1>
          <a className='mt-20 text-gray-400 font-bold' href='https://www.LinkedIn.com/in/ankit-kumar-635a62227'>https://www.LinkedIn.com/in/ankit-kumar-635a62227</a>
