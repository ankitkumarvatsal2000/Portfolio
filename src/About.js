...
const About = (props) => {
  ...
  return (
    <>
      ...
      <div className='block lg:flex  w-[1000px] m-auto items-center mt-24 pb-14'>
        <div className='flex-1'>
          <img className=' m-auto w-[700px]  mt-11 lg:w-[450px] h-[650px] rounded-lg' src={props.img}></img>
        </div>
        <div className=' lg:flex flex-col flex-1 '>
          ...
          <div className=' flex items-center lg:flex flex-col mt-12 gap-6'>
